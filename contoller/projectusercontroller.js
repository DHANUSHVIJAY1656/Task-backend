...
const assignUserToProject = async (req, res) => {
    ...
    try {
        ...
        const assignment = new ProjectUser({ project_id, user_id, role_in_project });
...
const getAllProjectUsers = async (req, res) => {
    try {
        const assignments = await ProjectUser.find().populate("project_id user_id", "project_name name email");
